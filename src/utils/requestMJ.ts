...
const devBaseUrl = "targetMJ/";
const proBaseUrl = "http://192.168.20.8:8087";
...
//拦截请求
requestMJ.interceptors.request.use(
  (config) => {
...
//拦截响应
requestMJ.interceptors.response.use(
  (response) => {
    return response;
  },
  (error) => {
