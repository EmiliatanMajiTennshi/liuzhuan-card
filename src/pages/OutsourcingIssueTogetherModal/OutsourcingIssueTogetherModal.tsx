...
const OutsourcingIssueTogetherModal = (props: any) => {
    ...
    <div>
      <Spin spinning={loading}>
        ...
        <span style={activeKey === "1" ? {} : { display: "none" }}>
          <OutsourcingPage {...commonFormProps} />
        </span>
        <span style={activeKey === "2" ? {} : { display: "none" }}>
          <OutsourcingPage {...commonFormPropsFinished} />
        </span>
...
export default OutsourcingIssueTogetherModal;
